...
```{r}
#| label: appendix-4-full-ttest
#| include: false

# Generate Multimedia Appendix 4: full paired t-test results table (all 7 columns)
...
The anonymized evaluation data, the analysis code, and the source code of the AI feedback generation system are openly available in the Zenodo repository [@Kondo2026-data]. The AI feedback generation prompt, the evaluation rubric, its translation process, and the full paired t-test results table are provided in Multimedia Appendices 1, 2, 3, and 4, respectively. The original clinical clerkship logs are not publicly available because some entries may contain personally identifiable information about medical students, and public release of the log texts would exceed the scope of consent obtained through the opt-out procedure approved by the ethics committee.

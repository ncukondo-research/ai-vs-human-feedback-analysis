...
A further implication concerns the prompt itself as an object of pedagogical design. In our study, embedding the five Steiss et al. rubric criteria (criteria-based guidance, clear directions for improvement, accuracy, prioritization, and supportive tone) directly in the prompt was the central intervention through which a particular conception of feedback quality was operationalized in the AI generation process. This is analogous to constructive alignment in instructional design [@Biggs1996-yt], in which intended outcomes are systematically aligned with the activities that generate them; in our case, the prompt was the activity and the rubric was the intended outcome. Recent applied guidance in health professions education has similarly recommended grounding generative AI prompts in institutional pedagogical and assessment frameworks, with explicit examples of embedding disciplinary reference standards into the prompt itself [@snchezmendiola-2025]. The rubric-score consistency we observed for AI feedback should therefore be read not as an inherent property of GPT-4o but as an outcome of how educational values were translated into the prompt design, an interpretation supported by experimental work showing that detailed prompts combined with low temperature settings yield near-perfect inter-replicate consistency in LLM rubric grading [@Yavuz2024-vj]. Recognizing the prompt as a design lever, rather than only as a source of bias, opens the same mechanism to other educators and institutions seeking to align AI feedback with their own assessment frameworks.

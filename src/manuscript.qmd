...
In addition to this rubric, we added a closed question to determine whether the evaluator could identify the source of the feedback, in other words, whether they were accurate in the answer if the feedback was written by a human or generated by AI. This identification question was presented only after evaluators had completed all rubric scoring and free-text comments for that feedback entry, so that knowledge or suspicion of the source could not influence their quality ratings. This is because previous research has shown that the feedback provider can influence how the feedback is perceived [@van-de-Ridder2014-ld; @Tripodi2021-mc], and understanding how evaluators perceive the feedback provider was considered important for the analysis.

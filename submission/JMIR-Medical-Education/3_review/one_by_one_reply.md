...
> "In our case, embedding the rubric criteria directly in the prompt operationalized a particular conception of feedback quality in AI generation. ... The rubric-score consistency we observed for AI feedback is therefore best read not as an inherent property of GPT-4o but as an outcome of this prompt configuration, consistent with experimental evidence that detailed prompts combined with low temperature settings yield near-perfect inter-replicate consistency in LLM rubric grading (Yavuz et al., 2024)."

...
RESPONSE: Thank you for this suggestion. We have revised the Conclusions sections of both the abstract (p.2) and the Discussion (p.35) to address all four elements, and ensured that their content is aligned.
...
RESPONSE: Thank you for this important observation. We acknowledge that the Steiss et al. rubric captures structural dimensions of feedback quality but does not directly measure clinically specific qualities such as diagnostic reasoning and professional judgment. This is precisely why this study adopted a mixed-methods design: open-ended evaluator comments were analyzed qualitatively to capture dimensions of feedback value that the rubric alone cannot assess. We agree that this scope should be made explicit so that readers do not interpret higher AI rubric scores as indicating overall educational superiority.

We have made the following changes to address this concern.

In the Methods section (1st paragraph of the Evaluation Instrument subsection, p.9), we added a framing note explaining that "because rubric-based instruments tend to emphasize structural dimensions rather than clinically specific qualities such as diagnostic reasoning and professional judgment, a complementary qualitative component was incorporated to capture dimensions of feedback value that rubric scoring alone cannot assess." This framing also serves to justify the mixed-methods design.

In the Methods section (3rd paragraph of the Prompt Development subsection, p.8), we now explicitly state that "the prompt embedded the five criteria of the Steiss et al. rubric as the evaluation framework for generating feedback, while supervising physicians received no rubric-based instruction." We state that "the study compares a rubric-optimized AI system with naturalistic supervisor feedback rather than constituting a neutral comparison of inherent feedback quality."

In the Results section (4th paragraph of the Comparison of Scores subsection, p.19), we added an interpretive paragraph following the score comparison data, directing readers to consider this design asymmetry when interpreting Tables 2 and 3, and referencing the qualitative themes of Perspective as a clinician and Continuity with practice as complementary evidence of clinical value that the rubric does not capture.

In the Limitations section (p.33), we substantially expanded the discussion of the rubric's scope. We now explicitly state that "the Steiss et al. rubric was designed for written academic feedback and emphasizes structural dimensions that are also embedded in the AI prompt, while clinically meaningful attributes such as diagnostic reasoning and professional judgment are not directly captured. Rubric score differences therefore reflect adherence to specific structural dimensions rather than overall educational quality."
...
We have also added a forward-looking note in the Discussion acknowledging that "newer large language models continue to improve in generating natural, human-like text, and that future iterations may substantially reduce the detectability of AI-generated feedback, potentially altering evaluator perceptions and the dynamics of blinded evaluation designs."

In the revised manuscript, we have addressed this concern in three places. First, in the Methods (4th paragraph of the Evaluation Instrument subsection, p.9), we now explicitly state that "the identification question was presented only after all rubric scoring and free-text comments had been completed." Second, in the Results (Identification of Feedback Source, p.22), we now note that this finding occurred despite the blinding procedures and direct readers to the Discussion for interpretive considerations. Third, in the Discussion (4th–5th paragraphs of the Comparison with the Literature subsection, p.30), we have expanded the paragraph on feedback source identification to discuss both aspects: the possibility that implicit recognition introduced expectancy bias, and the interpretation that perfect detection constitutes a substantive finding reflecting genuinely pronounced differences between the two feedback types, consistent with all five qualitative themes. We have also added a new limitation (Third) addressing this issue, including the logical impossibility of stratifying by perceived source when perceived and actual source are identical for every observation.
...
In response, we have added the following to the Methods section (3rd paragraph of the Prompt Development subsection, p.8): "the prompt explicitly embedded the five criteria of the Steiss et al. rubric as the evaluation framework for generating feedback, while supervising physicians provided feedback according to their usual clinical practice without rubric guidance." We now state explicitly that "the study compares a rubric-optimized AI system with naturalistic supervisor feedback rather than constituting a neutral comparison of inherent feedback quality."

This framing is presented in the Methods section (1st paragraph of the Evaluation Instrument subsection, p.9) and expanded in the Limitations section. We also added an interpretive paragraph at the end of the Comparison of Scores subsection in the Results (4th paragraph, p.19), directing readers to interpret the reported score differences with this design feature in mind.
...
RESPONSE: Thank you for this important point. We have substantively addressed the linguistic and cultural context in the revised manuscript. Rather than treating this solely as a limitation, we have added a dedicated paragraph in the Discussion (6th paragraph of the Comparison with the Literature subsection, p.32) that situates our findings within the emerging literature on language-dependent LLM performance. Specifically, we cite Strasser et al. (2026), who demonstrated that LLM accuracy on identical medical examination questions varied significantly by language (64%–87%), with English prompts generally yielding higher performance, and Harigai et al. (2024), who found that GPT-4 achieved significantly higher accuracy on English-translated radiology questions than on original Japanese versions (median 89 vs 70 points), attributing this gap to the predominance of English in training data and to Japanese-specific translation challenges. We discuss how these findings suggest that the quality of AI-generated feedback in our study may be partly shaped by GPT-4o's language-specific capabilities in Japanese and that the same model and prompt could produce qualitatively different feedback in other languages. We also discuss how the cultural context of Japanese medical education, where deference to senior clinicians is strongly emphasized, may have influenced evaluators' perceptions of the two feedback sources. We frame these contextual factors as underscoring the importance of conducting AI feedback research across diverse linguistic and cultural settings, rather than as limitations per se. In the Limitations (First, p.33), we retain the acknowledgment that generalizability needs confirmation across institutions and cultural contexts. In the Conclusions (p.35), we explicitly identify language and institutional context as dimensions requiring investigation.
...
RESPONSE: Thank you for this insightful observation. We agree that the original explanation risked circularity. In the revised Discussion (2nd paragraph of the Comparison with the Literature subsection, p.30), we now distinguish two separate mechanisms: AI's adherence to rubric criteria, which follows from embedding those criteria in the prompt, and the consistency of its output across different inputs, which is a structural consequence of using the same model and prompt configuration for every log entry. We explicitly state that "this consistency is best understood as a design feature of AI feedback generation rather than an inherently desirable educational property, as effective feedback may sometimes require selective emphasis tailored to individual learner needs." We also reframe supervisor variability as reflecting selective prioritization and clinical judgment, noting that supervisors chose which aspects to emphasize based on their professional assessment of each student's needs, resulting in variable but contextually responsive feedback.
...
RESPONSE: Thank you for raising this important point. We conducted Shapiro-Wilk tests (p.15) on the paired differences for all comparisons. The feedback length difference was normally distributed (W = 0.992, p = .550), supporting the paired t-test for that variable. However, all five rubric score differences departed significantly from normality (all W ≤ 0.939, all p < .001 after Bonferroni correction). As a sensitivity analysis, we conducted Wilcoxon signed-rank tests alongside the paired t-tests; the two methods yielded identical conclusions regarding statistical significance for every variable. We note that our primary analysis of rubric scores used cumulative link mixed models (Table 3), which do not assume normality of the outcome distribution. These results have been added as a new subsection ("Distribution Assessment and Sensitivity Analysis") at the beginning of the quantitative Results.

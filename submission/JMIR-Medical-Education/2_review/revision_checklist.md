...
| フェーズ | 完了 | 合計 | 進捗率 |
|---------|------|------|--------|
| Phase 1: 別リポジトリでの分析 | 6 | 12 | 50% |
| Phase 2: 原稿修正（高優先度） | 0 | 15 | 0% |
| Phase 3: 原稿修正（中優先度） | 5 | 14 | 36% |
...
- [ ] **割当詳細の確認** (N7)
  - フィードバックペアの並べ替え方法: _______________
  - 順序のバランス: バランスあり / なし
  - 評価者が同一部門の複数記録を評価: あり / なし
...
- [ ] **プロンプトの長さ指示** (H1, N3)
  - 長さ指示の有無: あり / なし
  - 指示内容: _______________
  - 最大トークン制限: あり(___)/ なし

- [ ] **API呼び出しの独立性** (H3)
  - 各フィードバックは独立したAPIコール: はい / いいえ
  - 文脈汚染の可能性: なし / あり（説明: ___）
...
- [ ] **ランダム化・割当プロセスの明確化** (N7)
  - Phase 1.2 の確認結果を Methods に反映

- [ ] **API呼び出しの独立性を明記** (H3)
  - Phase 1.3 の確認結果を Methods に反映
